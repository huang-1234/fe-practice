...
for (let i = 0, oLen = operations.length;i < oLen;i++) {
  ...
  switch (timeType) {
    case 'y':
      dateArr2[0] = eval(`${dateArr2[0]}${opeArr[0]}${opeArr[1]}`)
      break;
    case 'm':
      dateArr2[1] = eval(`${dateArr2[1]}${opeArr[0]}${opeArr[1]}`)
      break;
    case 'W':
      dateArr2[2] = eval(`${dateArr2[2]}${opeArr[0]}${opeArr[1]}*7`)
      break;
    case 'd':
      dateArr2[2] = eval(`${dateArr2[2]}${opeArr[0]}${opeArr[1]}`)
      break;
    case 'h':
      timeArr2[0] = eval(`${timeArr2[0]}${opeArr[0]}${opeArr[1]}`)
      break;
    case 'm':
      timeArr2[1] = eval(`${timeArr2[1]}${opeArr[0]}${opeArr[1]}`)
      break;
    case 's':
      timeArr2[2] = eval(`${timeArr2[2]}${opeArr[0]}${opeArr[1]}`)
      break;
